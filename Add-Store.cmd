...
for /f %%i in ('dir /b *UI.Xaml*2.4*.appx 2^>nul ^| find /i "x64"') do set "UI.XamlX64=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.4*.appx 2^>nul ^| find /i "x86"') do set "UI.XamlX86=%%i"
...
if /i %arch%==x64 (
set "DepStore=%VCLibsX64%,%VCLibsX86%,%UI.XamlX64%,%UI.XamlX86%,%Framework6X64%,%Framework6X86%,%Runtime6X64%,%Runtime6X86%"
set "DepInstaller=%VCLibsX64%,%VCLibsX86%"
) else (
set "DepStore=%VCLibsX86%,%UI.XamlX86%,%Framework6X86%,%Runtime6X86%"
